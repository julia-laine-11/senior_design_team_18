...
//     // 2. Setup PB2 (Input + Pull-down)
//     GPIOB->PUPDR |= (1 << 5); 

//     // 3. Setup PC7 & PC8 (Output High)
//     GPIOC->MODER |= (1 << 14) | (1 << 16);
//     GPIOC->BSRR   = (1 << 7)  | (1 << 8);

//     // 4. Setup PC6 (PWM Output) -- CRITICAL FIX HERE
//     // Set Alternate Function Mode (10)
//     GPIOC->MODER |= (1 << 13); 
//     // Set HIGH SPEED Mode (11) on PC6 to drive the MOSFET sharp
//     GPIOC->OSPEEDR |= (1 << 12) | (1 << 13); 

//     // 5. Configure Timer 3 (10 kHz)
//     TIM3->PSC = 0;          // 8MHz Clock
//     TIM3->ARR = 40 - 1;    // 8MHz / 800 = 10 kHz
//     TIM3->CCR1 = 0;         // Start Off
