...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC1     ------> ADC_IN11
    */
    HAL_GPIO_DeInit(GPIOC, CONTROLLER_X_Pin|CONTROLLER_Y_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART5)
  {
    ...
    PD2     ------> USART5_RX
    */
    HAL_GPIO_DeInit(USB_USART5_TX_GPIO_Port, USB_USART5_TX_Pin);

    HAL_GPIO_DeInit(USB_USART5_RX_GPIO_Port, USB_USART5_RX_Pin);
